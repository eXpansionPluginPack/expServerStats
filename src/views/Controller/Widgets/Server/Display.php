...
$link = $this->url(array('page'=>'Overview\Server', 'id'=>$this->id));

if ($data->isConnected == 1) :?>

    <a href="<?php echo $link; ?>" id="overview-server-<?php echo $this->id; ?>">
        <div class="uk-panel uk-panel-box panel-serverOverview">
            <div class="uk-panel-title  serverName ">
                ...
                <sup><?php echo ($data->server->ladderServerLimitMax / 1000) . "k"; ?></sup>
            </div>
            ...
            <table width="100%">
                ...
                <tr>
                    <td colspan="3" class="currentMap">
                        <?php echo $this->parseColors($data->currentMap->name) . ' ' . $this->l(
                                'by'
                            ) . ' ' . $this->parseColors($data->currentMap->author) ?>
                    </td>
                <tr>
